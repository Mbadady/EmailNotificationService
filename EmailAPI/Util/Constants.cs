...
namespace EmailAPI.Util
{
    public static class Constants
    {
        ...
        public static string serviceBusConnectionString = configuration["Emailnotificationserviceconnectionstring:ConnectionString"];
        public static string emailQueueName = configuration["TopicAndQueueNames:Emailnotificationservicequeuename"];
